...
#else
#define r8a7791_pm_init() do { } while (0)
...
enum {
	...
	SHDMA_SLAVE_SCIFA0_TX,
	SHDMA_SLAVE_SCIFA0_RX,
	SHDMA_SLAVE_SCIFA1_TX,
	SHDMA_SLAVE_SCIFA1_RX,
	SHDMA_SLAVE_SCIFA2_TX,
	SHDMA_SLAVE_SCIFA2_RX,
	SHDMA_SLAVE_SCIFB0_TX,
	SHDMA_SLAVE_SCIFB0_RX,
	SHDMA_SLAVE_SCIFB1_TX,
	SHDMA_SLAVE_SCIFB1_RX,
	SHDMA_SLAVE_SCIFB2_TX,
	SHDMA_SLAVE_SCIFB2_RX,
	SHDMA_SLAVE_HSCIF0_TX,
	SHDMA_SLAVE_HSCIF0_RX,
	SHDMA_SLAVE_HSCIF1_TX,
	SHDMA_SLAVE_HSCIF1_RX,
