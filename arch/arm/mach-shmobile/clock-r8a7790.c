...
enum {
	...
	MSTP131, MSTP130, MSTP128, MSTP127, MSTP124,
	MSTP_NR
};
...
static struct clk mstp_clks[MSTP_NR] = {
	...
	[MSTP131] = SH_CLK_MSTP32(&zs_clk, SMSTPCR1, 31, 0), /* VSP1 (SY) */
	[MSTP130] = SH_CLK_MSTP32(&zs_clk, SMSTPCR1, 30, 0), /* VSP1 (RT) */
	[MSTP128] = SH_CLK_MSTP32(&zs_clk, SMSTPCR1, 28, 0), /* VSP1 (DU0) */
	[MSTP127] = SH_CLK_MSTP32(&zs_clk, SMSTPCR1, 27, 0), /* VSP1 (DU1) */
...
static struct clk_lookup lookups[] = {
	...
	CLKDEV_DEV_ID("vsp1.1", &mstp_clks[MSTP131]),
	CLKDEV_ICK_ID("rt", "vsp1.0", &mstp_clks[MSTP130]),
	CLKDEV_ICK_ID("rt", "vsp1.1", &mstp_clks[MSTP130]),
