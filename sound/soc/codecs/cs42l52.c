...
static const struct snd_kcontrol_new cs42l52_snd_controls[] = {
	...
	SOC_SINGLE("Limiter Release Rate Volume", CS42L52_LIMITER_CTL2,
		   0, 63, 0),
	SOC_SINGLE("Limiter Attack Rate Volume", CS42L52_LIMITER_AT_RATE,
		   0, 63, 0),
	...
	/* ALC */
	SOC_SINGLE("ALC Attack Rate Volume", CS42L52_ALC_CTL, 0, 63, 0),
	SOC_SINGLE("ALC Release Rate Volume", CS42L52_ALC_RATE, 0, 63, 0),
...
static const struct snd_soc_dapm_widget cs42l52_dapm_widgets[] = {
	...
	SND_SOC_DAPM_MICBIAS("Mic Bias", CS42L52_PWRCTL2, 0, 1),
...
static const struct snd_soc_dapm_route cs42l52_audio_map[] = {
	...
	{"Mic Bias", NULL, "Capture"},
	{"Output Mux", "ADC", "Mic Bias"},
