...
int lut_enum_mbus_code(struct v4l2_subdev *subdev,
...
int lut_enum_frame_size(struct v4l2_subdev *subdev,
			      struct v4l2_subdev_fh *fh,
...
int lut_get_format(struct v4l2_subdev *subdev, struct v4l2_subdev_fh *fh,
...
int lut_set_format(struct v4l2_subdev *subdev, struct v4l2_subdev_fh *fh,
			 struct v4l2_subdev_format *fmt)
{
	struct vsp1_lut *lut = to_lut(subdev);
	struct v4l2_mbus_framefmt *format;
