...
int hsit_enum_mbus_code(struct v4l2_subdev *subdev,
...
int hsit_enum_frame_size(struct v4l2_subdev *subdev,
			      struct v4l2_subdev_fh *fh,
...
int hsit_get_format(struct v4l2_subdev *subdev, struct v4l2_subdev_fh *fh,
...
int hsit_set_format(struct v4l2_subdev *subdev, struct v4l2_subdev_fh *fh,
			 struct v4l2_subdev_format *fmt)
{
	struct vsp1_hsit *hsit = to_hsit(subdev);
	struct v4l2_mbus_framefmt *format;
